  ...
  gu: {
    ...
    rashifal: {
      ...
      messages: {
        ...
        taurus: 'વ્યવહારુ પอสિશન્સ લાભ આપશે. સંબંધો અને નિયમિતતામાં ધ્યાન આપો.',
        gemini: 'જિજ્ઞાસુતા નવા સંપર્ક લાવે છે. પહેલા સાંભળો અને પછી બોલો.',
        cancer: 'ઘર અને ભાવનાઓ સૌમ્ય છે. તમારા માટે શાંતિભર્યો સમય લો.',
        leo: 'તમારી કરીizma ચમકે છે. કોપરાયતમાં નમ્રતા સાથે નેતૃત્વ કરો.',
    ...
    numerology: {
      ...
      messages: {
        1: 'આગૂપણ અને સ્વતંત્રતા તમારા મંત્ર છે. તમારા સર્જનાત્મક પ્રેરણાને વિશ્વાસ આપો.',
